...
class Transformer(nn.Module):
    ...
    def __init__(self, num_embeddings, max_length, n, d_model, h, d_ff, dropout):
        """forward(input_ids, output_ids, attention_mask, causal_mask)"""
    ...
    def forward(self, input_ids, output_ids, attention_mask, causal_mask):
        ...
        encoder_output = self.encoder(input_emb, attention_mask)
        decoder_output = self.decoder(output_emb, encoder_output, attention_mask, causal_mask)
